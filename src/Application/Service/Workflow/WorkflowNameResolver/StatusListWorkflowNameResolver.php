...
class StatusListWorkflowNameResolver implements WorkflowNameResolverInterface
{
    private const PRE_DELIVERY_ORDER = 'pre_delivery_order_list';
    private const PRE_PICK_UP_ORDER = 'pre_pick_up_order_list';
    private const EXPRESS_DELIVERY_ORDER = 'express_delivery_order_list';
    private const EXPRESS_PICK_UP_ORDER = 'express_pick_up_order_list';
